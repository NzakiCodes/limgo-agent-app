      ...
      <ScrollView contentContainerStyle={{ flex: 1 }}>
        <View>
          ...
          <View style={{ marginVertical: 20 }}>
            ...
            />
            <Text style={{ color: "#e90000" }}>
              {error.email.errorValue ? error.email.message : ""}
            </Text>

            <TextField
              error={error.phoneNumber.errorValue}
              textBold
              title={"Phone Number"}
            ...
            />
            <Text style={{ color: "#e90000" }}>
              {error.phoneNumber.errorValue ? error.phoneNumber.message : ""}
            </Text>
        ...
        <View>
          ...
          >
            <Text
              style={{ color: "#4B4D5A", fontSize: 15, textAlign: "center" }}
            >
