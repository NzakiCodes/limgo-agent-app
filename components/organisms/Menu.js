    ...
    <>
      {isNavOpen ? (
        <Animated.View
          ...
          onTouchStart={(e) => closeFromTap(e)}
        >
          <Animated.View
            style={[styles.menu, { left: slideAnim }]}
            onTouchStart={(e) => closeFromTouch(e)}
          >
              ...
              <View style={styles.menuNavList}>
                ...
                >
                  <View style={styles.menuNavListItemGroup}>
                    ...
                    />
                    <Text style={styles.menuNavListItemText}>
                      Update Profile
                    </Text>
                  </View>
                  <Image
                    source={chevronForwardLightIcon}
                    style={styles.chevronForwardLightIcon}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.menuNavListItem}
